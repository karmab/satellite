...
channelgroup.add_option("-d", "--deletechannel", action="store_true", dest="deletechannel", help="Delete software channel")
...
channelgroup.add_option("-R", "--removechildchannel", dest="removechildchannel", type="string", help="Child channel to remove from machine")
